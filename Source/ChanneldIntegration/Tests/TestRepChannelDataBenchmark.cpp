...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FTestRepChannelDataBenchmark, "Channeld.TestRepChannelDataBenchmark", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::PerfFilter)
