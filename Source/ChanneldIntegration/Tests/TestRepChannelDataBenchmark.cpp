...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FTestRepChannelDataBenchmark, "Channeld.TPS", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::PerfFilter)
