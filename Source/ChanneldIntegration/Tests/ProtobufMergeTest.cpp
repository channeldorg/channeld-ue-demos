...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtobufMergeTest, "Channeld.ProtobufMergeTest", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
