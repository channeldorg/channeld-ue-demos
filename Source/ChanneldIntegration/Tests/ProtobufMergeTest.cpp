...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtobufMergeTest, "Channeld.ProtobufMergeTest", EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::ServerContext | EAutomationTestFlags::SmokeFilter)
