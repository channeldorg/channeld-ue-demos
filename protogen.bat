...
%PROTOC% --cpp_out=. -I "%CHANNELD_PATH%/examples/channeld-ue-tps/tpspb" -I "%CHANNELD_PATH%/pkg/channeldpb" tps.proto
del tps.pb.cpp
rename tps.pb.cc tps.pb.cpp


cd "%PROJECT_ROOT%/Plugins/ChanneldUE/Source/ChanneldUE/channeldpb"
...
%PROTOC% --cpp_out=.  --cpp_opt=dllexport_decl=CHANNELDUE_API -I "%CHANNELD_PATH%/pkg/channeldpb" unreal_common.proto
