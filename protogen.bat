...
%PROTOC% --cpp_out=. -I "%CHANNELD_PATH%/examples/channeld-ue-tps/tpspb" -I "%CHANNELD_PATH%" tps.proto
del tps.pb.cpp
rename tps.pb.cc tps.pb.cpp

cd "%PROJECT_ROOT%/Plugins/ChanneldUE/Source/ChanneldUE"

%PROTOC% --cpp_out=. -I "%CHANNELD_PATH%/pkg/channeldpb" -I "%PROTOBUF_PATH%" channeld.proto
del channeld.pb.cpp
...
%PROTOC% --cpp_out=. -I "%CHANNELD_PATH%/pkg/channeldpb" unreal_common.proto
